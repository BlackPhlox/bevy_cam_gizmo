...
fn build_gizmo(
    ...
    let unlit_grey = materials.add(StandardMaterial {
        unlit: true,
            ...
            parent
                .spawn_bundle(PbrBundle {
                    ...
                    transform: Transform::from_matrix(Mat4::from_scale_rotation_translation(
                        ...
                        Quat::from_rotation_z(std::f32::consts::PI / -2.0),
                        Vec3::new(axis_length/2.0+offset, 0.0, 0.),
                    )),
                    ..Default::default()
                })
            ...
            parent
                .spawn_bundle(PbrBundle {
                    ...
                    transform: Transform::from_matrix(Mat4::from_scale_rotation_translation(
                        Vec3::new(scale,scale,scale),
                        Quat::IDENTITY,
                        Vec3::new(0.0, axis_length/2.0+offset, 0.),
                    )),
                    ..Default::default()
                })
                .insert(PickableGizmo::default())
            ...
            parent
                .spawn_bundle(PbrBundle {
                    ...
                    transform: Transform::from_matrix(Mat4::from_scale_rotation_translation(
                        Vec3::new(scale,scale,scale),
                        Quat::from_rotation_x(std::f32::consts::PI / 2.0),
                        Vec3::new(0.0, 0.0, axis_length/2.0+offset),
                    )),
                    ..Default::default()
                })
                .insert(PickableGizmo::default())
                ...
                .insert(GizmoPass)
                .remove::<MainPass>();
            //Translation handles (Opposite)
            parent
                .spawn_bundle(PbrBundle {
                    mesh: cone_mesh.clone(),
                    material: unlit_grey.clone(),
                    transform: Transform::from_matrix(Mat4::from_scale_rotation_translation(
                        Vec3::new(scale,scale,scale),
                        Quat::from_rotation_z(std::f32::consts::PI / 2.0),
                        Vec3::new(-(axis_length/2.0+offset), 0.0, 0.),
